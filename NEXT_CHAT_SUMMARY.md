...
## 🛠️ تحديث 2026-07-12 (جلسة جديدة)

### تم
1. رأس جدول الجلاء بنفس كلمات النموذج الرسمي (المادة / الدرجة الدنيا / العظمى / درجة الأعمال / درجة الامتحان / المحصلة / الفصل الأول والثاني).
2. أسفل الجلاء: **مدير المدرسة فوق مشرف القسم** بشكل أنيق.
3. عند اختيار الطالب يتبدل نموذج الجلاء تلقائيًا حسب الصف.
4. بطاقات جديدة في شاشة الدرجات: مواد مُدخَلة للفصلين + **نسبة الإنجاز %** مع شريط تقدم.
5. الشريط العلوي: **عدد الذكور** و**عدد الإناث** بدل المعلمين/الموظفين + نسبة نجاح كل جنس.
6. أزرار الامتحانات (أول مادة / إدارة المواد / ...) في صف واحد متناسق.
7. شاشة الدخول: لا تظهر admin/admin تلقائيًا (حقول فارغة).
